...
#'
#' @import dplyr tidyr
#' @examples ## transect_glance_list can be used with the download_transect_list() function:
#'
#' transect_glance_list(download_transect_list(149, id %in% test_vector)) #149 is the database ID, see help file of download_assessment_list() for more information
#'
...
#' transect_glance_list(list)

transect_glance_list <- function(list){

  applied <- lapply(list, glance_transect)
